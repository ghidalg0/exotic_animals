...
####
animal_0l01 = Animal.new({ name: "Roro", species: "llama", location: "Thoiry", category: "funny", birthday: Date.new(2019, 12, 03), bio: "I love hugs ! I hate to wait ! And food should be good !", user: user_01 })
animal_0l01.photo.attach(io: roro, filename: "llama")
animal_0l01.save!
####
animal_0l02 = Animal.new({ name: "Ali", species: "camel", location: "Romagne", category: "funny", birthday: Date.new(2019, 12, 03), bio: "I love making jokes ! I come from Cuba and i love Mojito !", user: user_01 })
...
animal_0201 = Animal.new({ name: "Picpic", species: "peacock", location: "Lyon", category: "funny", birthday: Date.new(2017, 10, 03), bio: "Hi,i'm Picpic and I love joles ! I drink only water !", user: user_02 })
animal_0201.photo.attach(io: picpic, filename: "peacock")
animal_0201.save!
####
animal_0202 = Animal.new({ name: "Martin", species: "hedgehog", location: "Montpellier", category: "capricious", birthday: Date.new(2019, 12, 03), bio: "I want to eat ! NOW ! food is life and life is food !", user: user_02 })
...
####
animal_0301 = Animal.new({ name: "fifi", species: "crocodile", location: "Mulhouse", category: "grumpy", birthday: Date.new(2020, 12, 03), bio: "I love to sleep ! I need a big bed with lot of pillows", user: user_03 })
animal_0301.photo.attach(io: fifi, filename: "crocodile")
animal_0301.save!
####
animal_0302 = Animal.new({ name: "Willou", species: "chimpanzee", location: "Paris", category: "funny", birthday: Date.new(2018, 12, 03), bio: "i love women and ruby but not html so much !", user: user_03 })
...
####
animal_0401 = Animal.new({ name: "Dede", species: "reindeer", location: "Montpellier", category: "capricious", birthday: Date.new(2019, 12, 03), bio: "I'm a mannequin, take pictures of me please and NOW !", user: user_04 })
